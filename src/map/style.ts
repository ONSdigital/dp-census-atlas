...
export const style: mapboxgl.Style = {
  ...
  "layers": [
    ...
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {
        "line-color": {"base": 1, "stops": [[9, "#bbb"], [10, "#fff"]]},
    ...
    },
    {
      ...
      "paint": {
        "line-width": {"base": 1.55, "stops": [[13, 1.8], [20, 10]]},
        "line-opacity": 0.7,
        "line-color": "#fff"
      }
    },
...
export const styleDotDensity: mapboxgl.Style = {
  "version": 8,
  "name": "Positron",
  "metadata": {
  ...
  "layers": [
    ...
    },
    {
      ...
      "paint": {
        "fill-color": "rgb(234, 234, 230)",
        "fill-opacity": {"base": 1, "stops": [[8, 0], [12, 0]]}
      }
    },
    {
      "id": "waterway",
      ...
      "filter": ["==", "$type", "LineString"],
      "layout": {"visibility": "visible"},
      "paint": {"line-color": "hsl(100%, 100%, 100%)"}
    },
    {
      "id": "water_name",
      "type": "symbol",
