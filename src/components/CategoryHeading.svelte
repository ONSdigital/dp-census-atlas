...
<div>
	<div>
		<span>
			{areArgsDefined()
				? formatPercentage(variableData[category.code].percentage)
				: percentPlaceholder}<span>%</span>
		</span>
	</div>
	<div>
		<div>
			<span>
				{areArgsDefined()
					? formatCatHeadString(variable, category, location, category.category_h_pt2)
					: ''}
			</span>
		</div>
		<div>
			<span>
				{areArgsDefined()
					? formatCatHeadString(variable, category, location, category.category_h_pt3)
					: ''}
			</span>
		</div>
	</div>
