...
import type { MapState, SelectedGeographyData, ContentTree, VizData, AppParams, Category } from "../types";
...
/**
 * A Svelte store containing the currently data selected category.
 * */
export const categoryStore = writable<Category | undefined>(undefined);
